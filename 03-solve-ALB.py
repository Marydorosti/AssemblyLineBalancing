...
def evaluate(individual):
    ...
    graph=knapsack.get_sum_of_column_violaton(individual)[4]
    ss=GraphClass.Graph(graph)
    source = 0; sink = 46
    max_flow=ss.FordFulkerson(source, sink)
    #max_flow=0
    
    #f=[individual]
    #return knapsack.GET_COST(individual)[1],
    #return (knapsack.GET_COST(individual)[1]+knapsack.get_sum_of_column_violaton(individual)[12]),
    return knapsack.GET_COST(individual)[1],max_flow,
