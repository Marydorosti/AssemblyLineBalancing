...
#############################################################################################             
           ...
           if g>self.sie:
               #violations=violations+1
               violations=violations+(g-self.sie)
               
           #ss=GraphClass.Graph(graph1) 
...
#########################################################################################
    #def get_max_flow(self,attr_fltList):
...
############################*******GET_COST******#############################################3##         
    ...
    def GET_COST(self,attr_fltList):
             ...
             df=self.get_sum_of_column_violaton(attr_fltList)[10]
             #maxflow=self.get_sum_of_column_violaton(attr_fltList)[12]
